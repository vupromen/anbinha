        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{URL::to('/add-baiviet')}}">Thêm bài viết mới</a></li>
						<li><a href="{{URL::to('/all-baiviet')}}">Liệt kê bài viết</a></li>
                    </ul>
                </li>
            </ul>            </div>
        <!-- sidebar menu end-->
 ...
 <!-- footer -->
		  <div class="footer">
			<div class="wthree-copyright">
			  <p>© 2021 Visitors. All rights reserved | Design by admin</a></p>
			</div>
		  </div>
  <!-- / footer -->
</section>
